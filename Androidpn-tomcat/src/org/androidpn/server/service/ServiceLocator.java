...
public class ServiceLocator {
    ...
    public static String OPERATION_LOG_SERVICE = "operationLogService";
    /**
    ...
    public static OperationLogService getOperationLogService(){
        return (OperationLogService) XmppServer.getInstance().getBean(OPERATION_LOG_SERVICE);
    }
}
