...
abstract public class Node{
    ...
    protected ConcurrentHashMap<ItemEventListener<Item>, PacketListener> itemEventToListenerMap =
            new ConcurrentHashMap<ItemEventListener<Item>, PacketListener>();
    ...
    public class ItemEventTranslator implements PacketListener{
        ...
        public void processPacket(Packet packet){
            ...
            ItemPublishEvent eventItems = new ItemPublishEvent(itemsElem.getNode(), (List<Item>)itemsElem.getItems(), getSubscriptionIds(packet),
